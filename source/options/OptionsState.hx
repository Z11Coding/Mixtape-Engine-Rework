...
class OptionsState extends MusicBeatState
{
	...
	override function update(elapsed:Float) {
		...
		if (controls.BACK && !isEnteringKonamiCode) {
			...
			else FlxG.switchState(Type.createInstance(MenuTracker.mainMenuState, []));
		}
