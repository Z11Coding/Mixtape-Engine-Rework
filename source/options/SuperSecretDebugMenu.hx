	...
	function doDaUpdate():Void {
		if(ClientPrefs.data.checkForUpdates) {
			...
			http.onData = function (data:String)
			{
				...
				states.TitleState.updateVersion = returnedData[0];
				var curVersion:String = MenuTracker.psychEngineJSVersion.trim();
				states.OutdatedState.currChanges = returnedData[1];
			}
    	...
    	FlxG.switchState(states.OutdatedState.new);
	}
}
