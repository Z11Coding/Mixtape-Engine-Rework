...
class MixtapeMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		#if !debug
		versionShit.text = "Mixtape Engine v" + MenuTracker.mixtapeEngineVersion;
		#else
		versionShit.text = "Mixtape Engine v" + MenuTracker.mixtapeEngineVersion + ' (debug)';
		#end
		...
		versionShitpsych.text = "Psych Engine v" + MenuTracker.psychEngineVersion;
		funnytext.screenCenter(X);
		versionShit.screenCenter(X);
		versionShitpsych.screenCenter(X);
		var versionShitFriday:FlxText = new FlxText(12, FlxG.height - 24, 0, "FNF v" + MenuTracker.fridayVersion, 12);
