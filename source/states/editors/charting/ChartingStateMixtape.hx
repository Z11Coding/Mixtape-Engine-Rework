...
import sys.io.File;
#end
import states.MusicBeatChartingState;
import states.editors.content.*;

@:access(flixel.sound.FlxSound._sound)
@:access(openfl.media.Sound.__buffer)
class ChartingStateMixtape extends MusicBeatChartingState
{
	...
	**/
	...
	override function update(elapsed:Float)
	{
		...
		if (!blockInput)
		{
			if (FlxG.keys.justPressed.ESCAPE)
			{
				...
				//openSubState(new states.editors.EditorPlayState());
			}
	...
	function setupNoteData(i:Array<Dynamic>, isNextSection:Bool):Note
	{
		...
		var note:Note = new Note(daStrumTime, daNoteInfo % Note.ammo[_song.mania]);
		if (daSus != null)
		{ // Common note
