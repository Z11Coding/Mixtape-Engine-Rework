...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var leText:String = Language.getPhrase("freeplay_tip", "Press SPACE to listen to the Song / Press CTRL to open the Gameplay Changers Menu / Press RESET to Reset your Score and Accuracy. / Hold SHIFT to Move");
		bottomString = leText;
		var size:Int = 16;
