...
import backend.funkinmodchart.engine.events.types.*;
import backend.funkinmodchart.engine.modifiers.list.*;
import flixel.FlxBasic;
import flixel.tweens.FlxEase.EaseFunction;
import flixel.util.FlxSort;
import haxe.ds.Vector;

@:allow(backend.funkinmodchart.backend.ModifierGroup)
@:access(backend.funkinmodchart.engine.PlayField)
#if !openfl_debug
...
final class Manager extends FlxBasic {
	...
	public var renderArrowPaths:Bool = true;
