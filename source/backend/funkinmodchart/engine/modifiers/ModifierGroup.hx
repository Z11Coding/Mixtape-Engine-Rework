...
import backend.funkinmodchart.backend.core.PercentArray;
import backend.funkinmodchart.backend.core.VisualParameters;
import backend.funkinmodchart.backend.macros.ModifiersMacro;
...
import backend.funkinmodchart.engine.modifiers.list.false_paradise.*;
