package backend.funkinmodchart.backend.util;

import backend.funkinmodchart.engine.events.Event;
import backend.funkinmodchart.engine.events.types.AddEvent;
import backend.funkinmodchart.engine.events.types.EaseEvent;
...
@:keep class ModchartUtil {
	...
	@:pure
	inline public static function resolveCameras(playfield:backend.funkinmodchart.engine.PlayField, item:FlxSprite):Array<FlxCamera> {
		@:privateAccess
