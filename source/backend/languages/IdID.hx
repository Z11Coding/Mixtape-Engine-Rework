...
class IdID
{
    ...
    public static var translations:Map<String, String> = [
        ...
        "setting_time_bar-time_elapsed" => "Waktu yang Telah Berlalu",
        ...
        "setting_show_key_viewer" => "Tampilkan Tampilan Key",
