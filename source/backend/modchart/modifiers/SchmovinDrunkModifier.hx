...
class SchmovinDrunkModifier extends NoteModifier {
	...
	override function getPos(visualDiff:Float, timeDiff:Float, beat:Float, pos:Vector3, data:Int, player:Int, obj:FlxSprite, field:NoteField)
	{
		...
		pos.x += applyDrunk('Tan', player, beat, visualDiff, data, field.field.keyCount, Math.tan)
			+ applyTipsy('TanX', player, beat, visualDiff, data, field.field.keyCount, Math.tan)
			+ applyBumpy('TanX', player, beat, visualDiff, data, Math.tan);

		pos.y += applyDrunk('TanY', player, beat, visualDiff, data, field.field.keyCount, Math.tan)
			+ applyTipsy('Tan', player, beat, visualDiff, data, field.field.keyCount, Math.tan)
			+ applyBumpy('TanY', player, beat, visualDiff, data, Math.tan);

		pos.z += applyDrunk('TanZ', player, beat, visualDiff, data, field.field.keyCount, Math.tan)
			+ applyTipsy('TanZ', player, beat, visualDiff, data, field.field.keyCount, Math.tan)
			+ applyBumpy('Tan', player, beat, visualDiff, data, Math.tan);
