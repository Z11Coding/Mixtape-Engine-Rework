...
@:structInit class SaveVariables {
	...
	public var camera3dEnabled:Bool = true;
	public var zScale:Float = 1.0;
	public var renderArrowPaths:Bool = false;
	public var styledArrowPaths:Bool = false;
	public var arrowPathFrameSkip:Int = 2;
	public var arrowPathBoundary:Int = 300;
	public var holdCacheEnabled:Bool = true;
	public var holdAlphaDivisions:Int = 20;
	public var seamlessHoldExtension:Float = 2.0;
	public var holdEndScale:Float = 1.0;
	public var preventScaledHoldEnd:Bool = false;
	public var columnSpecificModifiers:Bool = true;
	public var holdsBehindStrum:Bool = false;
