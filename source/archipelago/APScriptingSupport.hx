...
class APScriptingSupport 
{
    ...
    {
        if (!APEntryState.inArchipelagoMode) return;
    ...
    {
        // Mode is controlled by APEntryState.inArchipelagoMode
        initialize();
    }
    ...
    {
        if (!APEntryState.inArchipelagoMode || APGameState.instance == null) return false;
    ...
    {
        if (!APEntryState.inArchipelagoMode || APGameState.instance == null) return 0;
    ...
    {
        return APEntryState.inArchipelagoMode && APGameState.instance != null && APGameState.instance.info() != null;
    }
    ...
    {
        if (!APEntryState.inArchipelagoMode) return false;
    ...
    {
        if (!APEntryState.inArchipelagoMode) return null;
