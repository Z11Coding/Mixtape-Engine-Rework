...
class CreditsPopUp extends FlxSpriteGroup
{
	...
	public function new(x:Float, y:Float, title:String = '', songCreator:String = '')
	{
		...
		headingPath = {path: PlayState.SONG.songCreditBarPath.length <= 0 ? 'JSEHeading' : 'songHeadings/' + PlayState.SONG.songCreditBarPath, antiAliasing: ClientPrefs.data.globalAntialiasing, iconOffset: 0};
