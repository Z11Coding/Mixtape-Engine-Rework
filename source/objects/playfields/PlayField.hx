...
class PlayField extends FlxTypedGroup<FlxBasic>
{
	...
	public var keybinds:Array<Int> = []; // keybinds for each column. can be set to a different set of keybinds to give it a different set of controls. can be set to null to sync the keybinds w/ player binds.
