...
@:build(trolllua.macros.ScriptingMacro.createEnumWrapper(flixel.text.FlxText.FlxTextAlign))
class FlxTextAlign{}

@:build(trolllua.macros.ScriptingMacro.createEnumWrapper(openfl.display.BlendMode))
class BlendMode{}

@:build(trolllua.macros.ScriptingMacro.createEnumWrapper(flixel.util.FlxAxes))
class FlxAxes {}
