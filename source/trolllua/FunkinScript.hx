...
abstract class FunkinScript 
{
	...
	**/
	function setDefaultVars(){
		...
		set('version', "1.0.3"); // version of psych troll engine is based on
		...
		//set('hideHud', ClientPrefs.data.hudOpacity > 0.0);
		set('timeBarType', ClientPrefs.data.timeBarType);
		set('scoreZoom', ClientPrefs.data.scoreZoom);
		//set('cameraZoomOnBeat', ClientPrefs.data.camZoomP > 0.0);
		...
		set("inTitlescreen", (currentState is states.TitleState));
		...
		if (currentState is PlayState && currentState == PlayState.instance) {
			...
			set('disableModcharts', !ClientPrefs.data.modcharts);
			set('noDropPenalty', true);
			set('practice', PlayState.instance.practiceMode);
			set('opponentPlay', PlayState.instance.opponentmode);
