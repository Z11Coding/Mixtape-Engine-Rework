...
class RankingSubstate extends MusicBeatSubstate
{
	...
	{
		if (PlayState.instance.songMisses == 0 && PlayState.instance.bads == 0 && PlayState.instance.shits == 0 && PlayState.instance.goods == 0 && PlayState.instance.sicks == 0 && PlayState.instance.marvs == 0 && ClientPrefs.data.useMarvs && !ClientPrefs.data.noPerfectJudge) // Perfect Full Combo
			{ comboRank = "PFC"; comboRankLimit = 1; }
		else if (PlayState.instance.songMisses == 0 && PlayState.instance.bads == 0 && PlayState.instance.shits == 0 && PlayState.instance.goods == 0 && PlayState.instance.sicks == 0 && ClientPrefs.data.useMarvs) // Marvelous Full Combo
			{ comboRank = "MFC"; comboRankLimit = 2; }
		else if (PlayState.instance.songMisses == 0 && PlayState.instance.bads == 0 && PlayState.instance.shits == 0 && PlayState.instance.goods == 0) // Sick Full Combo
			{ comboRank = "SFC"; comboRankLimit = 3; }
			...
			{ comboRank = "GFC"; comboRankLimit = 4; }
		else if (PlayState.instance.songMisses == 0 && PlayState.instance.bads >= 1 && PlayState.instance.shits == 0 && PlayState.instance.goods >= 0) // Alright Full Combo (Bads, Goods and Sicks)
			{ comboRank = "AFC"; comboRankLimit = 5; }
		else if (PlayState.instance.songMisses == 0) // Regular FC
			{ comboRank = "FC"; comboRankLimit = 6; }
		else if (PlayState.instance.songMisses < 10) // Single Digit Combo Breaks
			{ comboRank = "SDCB"; comboRankLimit = 7; }
