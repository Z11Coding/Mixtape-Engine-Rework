...
class ExitConfirmationPrompt extends Prompt2
{
...
class Prompt2 extends BasePrompt2
{
...
class BasePrompt2 extends MusicBeatSubstate
{
	var _sizeX:Float = 0;
	var _sizeY:Float = 0;
	var _title:String;

	public var onCreate:BasePrompt2->Void;
	public var onUpdate:BasePrompt2->Float->Void;
	public function new(?sizeX:Float = 420, ?sizeY:Float = 160, title:String, ?onCreate:BasePrompt2->Void, ?onUpdate:BasePrompt2->Float->Void)
	{
		this._sizeX = sizeX;
		this._sizeY = sizeY;
		this._title = title;
