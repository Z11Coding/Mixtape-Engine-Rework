...
class Prompt extends MusicBeatSubstate
{
	...
	override public function update(elapsed:Float):Void
	{
		...
		if (!goAnyway){
			...
			if (buttonNo != null) buttonNo.color.brightness = 0.5;
			if (selected == 0 ) buttonAccept.color.brightness = 0.9;
			if (selected == 1 && buttonNo != null) buttonNo.color.brightness = 0.9;
			if (controls.ACCEPT ){
				if (selected == 0){
