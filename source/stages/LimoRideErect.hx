...
import backend.BaseStage.HenchmenKillState;

class LimoRideErect extends backend.BaseStage
{
	...
	{
		var skyBG:BGSprite = new BGSprite('stages/limo/erect/limoSunset', -120, -50, 0.1, 0.1);
		skyBG.scale.set(0.9, 0.9);
		skyBG.updateHitbox();
		add(skyBG);

		star = new BGSprite('stages/limo/erect/shooting star', 200, 0, 1, 1, ['shooting star']);
		...
		if (!ClientPrefs.data.lowQuality)
		{
			...
			bgLimo = new BGSprite('stages/limo/limo/erect/bgLimo', -150, 480, 0.4, 0.4, ['background limo blue'], true);
			add(bgLimo);
	...
	function makeMists()
	{
		mist1 = new FlxBackdrop(Paths.image('stages/limo/erect/mistMid'), X);
		...
		mist2 = new FlxBackdrop(Paths.image('stages/limo/erect/mistBack'), X);
		...
		mist3 = new FlxBackdrop(Paths.image('stages/limo/erect/mistMid'), X);
		...
		mist4 = new FlxBackdrop(Paths.image('stages/limo/erect/mistBack'), X);
		...
		mist5 = new FlxBackdrop(Paths.image('stages/limo/erect/mistMid'), X);
	...
	override function createPost()
	{
		...
		var limo:BGSprite = new BGSprite('stages/limo/erect/limoDrive', -120, 550, 1, 1, ['Limo stage'], true);
