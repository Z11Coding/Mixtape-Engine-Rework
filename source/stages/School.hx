...
class School extends backend.BaseStage
{
	...
	override function create()
	{
		...
		var widShit = Std.int(bgSky.width * states.PlayState.daPixelZoom);
	...
	function initDoof()
	{
		...
		doof = new DialogueBox(false, utils.CoolUtil.coolTextFile(file));
		doof.cameras = [camHUD];
		doof.scrollFactor.set();
		doof.finishThing = startCountdown;
		doof.nextDialogueThing = states.PlayState.instance.startNextDialogue;
		doof.skipDialogueThing = states.PlayState.instance.skipDialogue;
	}
