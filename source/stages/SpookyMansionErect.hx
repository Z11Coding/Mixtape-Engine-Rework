...
class SpookyMansionErect extends PicoCapableStage
{
	...
	function makeChars()
	{
		var bfName = states.PlayState.instance.boyfriend.curCharacter == 'pico-dark' ? "pico-playable" : "bf";
		...
		var gfMode = states.PlayState.instance.gf.curCharacter == 'nene-dark' ? "nene" : "gf";
