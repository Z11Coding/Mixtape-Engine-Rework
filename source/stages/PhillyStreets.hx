...
import backend.BaseStage.NeneState;
import states.PlayState;

class PhillyStreets extends backend.BaseStage
{
	...
	override function create()
	{
		...
		{
			var skyImage = Paths.image('stages/weekend/phillyStreets/phillySkybox');
			...
			var phillySkyline:BGSprite = new BGSprite('stages/weekend/phillyStreets/phillySkyline', -545, -273, 0.2, 0.2);
			add(phillySkyline);
			darkenable.push(phillySkyline);

			var phillyForegroundCity:BGSprite = new BGSprite('stages/weekend/phillyStreets/phillyForegroundCity', 625, 94, 0.3, 0.3);
			add(phillyForegroundCity);
			darkenable.push(phillyForegroundCity);
		}

		var phillyConstruction:BGSprite = new BGSprite('stages/weekend/phillyStreets/phillyConstruction', 1800, 364, 0.7, 1);
		add(phillyConstruction);
		darkenable.push(phillyConstruction);

		var phillyHighwayLights:BGSprite = new BGSprite('stages/weekend/phillyStreets/phillyHighwayLights', 284, 305, 1, 1);
		...
		var phillyHighway:BGSprite = new BGSprite('stages/weekend/phillyStreets/phillyHighway', 139, 209, 1, 1);
		add(phillyHighway);
		...
		if(!ClientPrefs.data.lowQuality)
		{
			...
			for (i in 0...2)
			{
				var car:BGSprite = new BGSprite('stages/weekend/phillyStreets/phillyCars', 1200, 818, 0.9, 1, ['car1', 'car2', 'car3', 'car4'], false);
				add(car);
				switch(i)
				{
			...
			phillyTraffic = new BGSprite('stages/weekend/phillyStreets/phillyTraffic', 1840, 608, 0.9, 1, ['redtogreen', 'greentored'], false);
			add(phillyTraffic);
			darkenable.push(phillyTraffic);

			var phillyTrafficLightmap:BGSprite = new BGSprite('stages/weekend/phillyStreets/phillyTraffic_lightmap', 1840, 608, 0.9, 1);
		...
		var phillyForeground:BGSprite = new BGSprite('stages/weekend/phillyStreets/phillyForeground', 88, 317, 1, 1);
	...
	function precache()
	{
		...
		function precacheCasing()
		{
			...
			if(!ClientPrefs.data.lowQuality)
			{
				casingFrames = Paths.getSparrowAtlas('stages/weekend/PicoBullet'); //precache
