...
class Tank extends backend.BaseStage
{
	...
	function prepareCutscene()
	{
		...
		Paths.loadAnimateAtlas(tankman, 'stages/grounds/cutscenes/tankman');
	...
	function stressIntro()
	{
		...
		Paths.loadAnimateAtlas(pico, 'stages/grounds/cutscenes/picoAppears');
