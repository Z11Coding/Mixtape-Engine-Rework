...
class SubStateScriptHandler {
  ...
  public static function setSubState(nameFile:String, stateInstance:Dynamic) {
    #if HSCRIPT_ALLOWED
    startHScriptNamed('substates/$nameFile.hx');
    #end

    #if LUA_ALLOWED
    startLuaNamed('substates/$nameFile.lua');
    #end
