...
class UnoOptionsSubState extends MusicBeatSubstate
{
    ...
    private function loadCurrentSettings():Void
    {
        ...
        if (forcePlay != null) UnoRules.DRAW_UNTIL_PLAYABLE = forcePlay;
    ...
    private function setupRulesTab():Void
    {
        ...
        forcePlayCheckbox.checked = UnoRules.DRAW_UNTIL_PLAYABLE;
        forcePlayCheckbox.onClick = function() {
            UnoRules.DRAW_UNTIL_PLAYABLE = forcePlayCheckbox.checked;
            saveRulesSettings();
        };
    ...
    private function resetAllSettings():Void
    {
        ...
        if (forcePlayCheckbox != null) forcePlayCheckbox.checked = UnoRules.DRAW_UNTIL_PLAYABLE;
    ...
    private function saveRulesSettings():Void
    {
        ...
        saveWrapper.addItem("forcePlay", UnoRules.DRAW_UNTIL_PLAYABLE);
