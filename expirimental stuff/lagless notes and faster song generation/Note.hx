...
typedef PreloadedChartNote = {
	...
	field:PlayField,
	fieldIndex:Int,
	tail:Array<PreloadedChartNote>,
	unhitTail:Array<PreloadedChartNote>,
	childs:Array<PreloadedChartNote>,
...
class Note extends NoteObject
{
	...
	public var template:PreloadedChartNote = null;
	...
	**/
	...
	public function new(?strumTime:Float, ?noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?inEditor:Bool = false, ?createdFrom:Dynamic = null)
	{
		...
		this.objType = NOTE;
		this.moves = false;
		if (strumTime != null && noteData != null) {
	...
	public static function quickMakeNote(template:PreloadedChartNote):Note {
	...
	public function quickSetNote(template:PreloadedChartNote) {
		this.strumTime = template.strumTime;
		this.noteData = template.noteData;
		this.prevNote = template.prevNote;
		this.isSustainNote = template.isSustainNote;
		this.inEditor = template.inEditor;
		this.mustPress = template.mustPress;
		this.noteType = template.noteType;
		this.animSuffix = template.animSuffix;
		this.sustainLength = template.sustainLength;
		this.noAnimation = template.noAnimation;
		this.noMissAnimation = template.noMissAnimation;
		this.gfNote = template.gfNote;
		this.hitHealth = template.hitHealth;
		this.missHealth = template.missHealth;
		this.hitCausesMiss = template.hitCausesMiss;
		this.ignoreNote = template.ignoreNote;
		this.blockHit = template.blockHit;
		this.lowPriority = template.lowPriority;
		this.row = template.row;
		this.holdType = template.holdType;
		this.isParent = template.isParent;
		this.multSpeed = template.multSpeed;
		this.noteIndex = template.noteIndex;
		this.field = template.field;
		this.fieldIndex = template.fieldIndex;
		this.spotInLine = template.spotInLine;
		this.AIStrumTime = template.AIStrumTime;
		this.AIMiss = template.AIMiss;
		this.inEditor = template.inEditor;
		this.spawned = template.spawned;
