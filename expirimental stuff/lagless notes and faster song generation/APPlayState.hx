...
class APPlayState extends PlayState {
	...
	function addNoteSvCLegacy(type:Int = 0, min:Int = 0, max:Int = 0, ?specificData:Int)
	{
		...
		if (chartModifier == "SpeedUp")
			{swagNote.multSpeed = 0.0001 * playbackRate;}
...
**/
    ...
    override function goodNoteHit(note:Note, preloadNote:PreloadedChartNote, field:PlayField):Void
    {
        if (note.specialNote)
		{
        ...
        super.goodNoteHit(note, preloadNote, field);
    }
