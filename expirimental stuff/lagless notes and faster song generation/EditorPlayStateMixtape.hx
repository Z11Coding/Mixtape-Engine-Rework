...
class EditorPlayStateMixtape extends MusicBeatSubstate
{
	...
	function opponentNoteHit(note:Note, preloadNote:PreloadedChartNote, field:PlayField):Void
	{
	...
	function goodNoteHit(note:Note, preloadNote:PreloadedChartNote, field:PlayField):Void
	{
