...
exports.YScriptValidator = void 0;
class YScriptValidator {
    constructor() {
        this.errors = [];
    }
    validate(ast) {
    ...
    validateProgram(node) {
        ...
        for (const stmt of node.body) {
            if (stmt.type === 'VariableDeclaration' || stmt.type === 'FunctionDeclaration' || stmt.type === 'ClassDeclaration') {
                const name = stmt.name?.name || stmt.identifier?.name;
                if (name) {
...
exports.YScriptValidator = YScriptValidator;
